...
public class JobsAdapter extends RecyclerView.Adapter<JobsAdapter.ViewHolder>
{
    ...
    {
        private TextView txtTitle,txtDate,txtDeadline,txtEdu,txtCompany,txtName,txtAppliedJob,txtSalary;
        ...
        private ViewHolder(View view) {
            ...
            txtAppliedJob = view.findViewById(R.id.txtAppliedJob);
            infoMap = new HashMap<>();
        ...
        private void setData(JobsModel model, int pos)
        {
            ...
            if(currentModel.isAppliedJob())
                txtAppliedJob.setText("Applied");
            else txtAppliedJob.setVisibility(View.GONE);
            ...
            else infoMap.put("appliedJob","no");
